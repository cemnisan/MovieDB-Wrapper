...
extension MovieService
{
    public func getPopularMovies(pageNumber: Int) async -> Result<PopularMovies, RequestError>
    {
        return await execute(
            endpoint: PopularMoviesEndpoint.popularMovies(pageNumber: pageNumber),
    ...
    {
        return await execute(
            endpoint: MovieDetailsEndpoint.movieDetail(id: id),
    ...
    {
        return await execute(
            endpoint: MovieReviewsEndpoint.movieReviews(id: id,
    ...
    {
        return await execute(
            endpoint: SimilarMoviesEndpoint.similarMovies(id: id,
                                                          pageNumber: pageNumber),
    ...
    {
        return await execute(
            endpoint: UpcomingMoviesEndpoint.upcomingMovies(pageNumber: pageNumber),
